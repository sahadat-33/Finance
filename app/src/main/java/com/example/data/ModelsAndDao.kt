...
data class Category(
    ...
    fun toMap(): Map<String, Any> = mapOf("id" to id, "name" to name, "type" to type, "isDefault" to isDefault, "updatedAt" to updatedAt, "uuid" to uuid, "sortOrder" to sortOrder)
    companion object {
...
data class SavingsVault(
    ...
    fun toMap(): Map<String, Any> = mapOf("id" to id, "assetType" to assetType, "amount" to amount, "updatedAt" to updatedAt, "uuid" to uuid, "sortOrder" to sortOrder)
    companion object {
...
interface FinanceDao {
    ...
    @Query("SELECT * FROM savings_vault ORDER BY sortOrder ASC, id ASC")
    ...
    @Update
    suspend fun updateSavingsVaults(vaults: List<SavingsVault>)
